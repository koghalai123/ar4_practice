...
def main(args=None):
    ...
    for j in range(simulator.numIters):
        ...
        results = simulator.process_iteration_results(simulator.targetArrayActual, simulator.targetArrayCommanded,simulator.numJacobianTrans,simulator.numJacobianRot)
